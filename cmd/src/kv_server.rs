...
//! implementation
use clap::Parser;
use front::client_fs::lab::{self, serve_back};
use log::{info, LevelFilter};
use tribbler::{config::BackConfig, error::TritonFileResult};
...
async fn main() -> TritonFileResult<()> {
    ...
    env_logger::builder()
        ...
        .init();
    let memstorage = Box::new(tribbler::storage::RemoteFileSystem::new(1));
