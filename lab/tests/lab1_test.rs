...
//     storage::{KeyList, KeyString, KeyValue, Pattern, RemoteFileSystem, Storage},
// };
...
//         Some(x) => x,
//         None => Box::new(RemoteFileSystem::new(0)),
//     };
...
//         )));
//     }
//     let client = new_client(format!("http://{}", addr).as_str()).await?;
...
// async fn test_get_set() -> TritonFileResult<()> {
...
// // #[tokio::test(flavor = "multi_thread", worker_threads = 4)]
// // async fn test_get_set_overwrite() -> TritonFileResult<()> {
// //     let (client, _handle, _tx) = setup(None, None).await?;
...
// // #[tokio::test(flavor = "multi_thread", worker_threads = 4)]
// // async fn test_set_none() -> TritonFileResult<()> {
...
// // #[tokio::test(flavor = "multi_thread", worker_threads = 4)]
// // async fn test_keys() -> TritonFileResult<()> {
// //     let (client, _handle, _tx) = setup(None, None).await?;
...
// // }
// // #[tokio::test(flavor = "multi_thread", worker_threads = 4)]
// // async fn test_list() -> TritonFileResult<()> {
// //     let (client, _handle, _shut) = setup(None, None).await?;
...
// // #[tokio::test(flavor = "multi_thread", worker_threads = 4)]
// // async fn test_list_keys() -> TritonFileResult<()> {
...
// // #[tokio::test(flavor = "multi_thread", worker_threads = 4)]
// // async fn test_awaited() -> TritonFileResult<()> {
...
// // #[tokio::test(flavor = "multi_thread", worker_threads = 4)]
// // async fn test_bad_address() -> TritonFileResult<()> {
// //     let (tx, rx): (Sender<bool>, Receiver<bool>) = mpsc::channel();
// //     let cfg = BackConfig {
// //         addr: "^_^".to_string(),
// //         storage: Box::new(RemoteFileSystem::default()),
// //         ready: Some(tx),
// //         shutdown: None,
// //     };
// //     let handle = spawn_back(cfg);
...
// // #[tokio::test(flavor = "multi_thread", worker_threads = 4)]
// // async fn test_store_before_serve() -> TritonFileResult<()> {
// //     let (tx, rx): (Sender<bool>, Receiver<bool>) = mpsc::channel();
// //     let store = RemoteFileSystem::default();
...
// // #[tokio::test(flavor = "multi_thread", worker_threads = 4)]
// // async fn test_multi_serve() -> TritonFileResult<()> {
// //     let (tx, rx): (Sender<bool>, Receiver<bool>) = mpsc::channel();
// //     let cfg = BackConfig {
// //         addr: DEFAULT_HOST.to_string(),
